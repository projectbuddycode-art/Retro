...
import { ArrowRight, ChevronRight, Code2, Database, Globe, Smartphone, Check, ShieldCheck, Settings2 } from "lucide-react";
import { motion } from "framer-motion";

const capabilities = [
  { title: "Enterprise Web Applications", desc: "Full-stack platforms built for scale, security and real business workflows." },
  { title: "Internal Control Dashboards", desc: "Custom operations dashboards giving your team unified visibility." },
  { title: "Customer Self-Service Portals", desc: "Secure, intuitive portals that reduce support overhead and improve customer experience." },
  { title: "Business Workflow Automation", desc: "Software that eliminates manual steps from your operational processes." },
  { title: "Custom REST & GraphQL APIs", desc: "Clean, documented APIs that integrate with your existing infrastructure." },
  { title: "Microservices & Cloud Architecture", desc: "Scalable cloud-native architecture on GCP and AWS." },
];

const outcomes = [
  "Software engineered around your operational reality — not generic templates",
  "100% client IP ownership — no vendor lock-in",
  "Production-grade quality tested against real-world loads",
  "Ongoing technical support and capability expansion",
];
      ...
      <main className="flex-grow">
        ...
        <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <nav className="flex items-center gap-2 text-xs font-mono text-slate-400 mb-12" aria-label="Breadcrumb">
              ...
              <ChevronRight className="w-3 h-3" />
              <span className="text-[#0052FF]">Custom Software Development</span>
            </nav>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-base sm:text-lg text-slate-600 leading-relaxed font-normal">
                  Off-the-shelf software forces businesses to change their processes to fit rigid SaaS paradigms. We build custom software engineered specifically around your established business workflows.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-2">
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-[#0052FF] hover:bg-[#0043D6] text-white text-sm font-semibold shadow-pb-glow transition-all active:scale-95"
                  >
              ...
              >
                <div className="relative rounded-3xl overflow-hidden border border-slate-200 bg-slate-950 shadow-2xl aspect-[4/3]">
                  <LazyVideo
                    src="/videos/Enterprise_software_motion_graphic_202608030216.mp4"
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white border-y border-slate-200">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              className="mb-12"
            >
              <span className="text-[11px] font-mono font-bold tracking-widest text-[#0052FF] uppercase block mb-3">WHAT WE DELIVER</span>
              <h2 className="font-display font-bold text-3xl sm:text-4xl text-slate-900 tracking-tight">Capabilities & Deliverables.</h2>
            </motion.div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#050917] text-white">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <h2 className="font-display font-bold text-3xl sm:text-5xl text-white tracking-tight">Ready to Build Your System?</h2>
            <p className="text-slate-400 text-base max-w-xl mx-auto">Let's understand your operational requirements and define the right architecture.</p>
            <button
              onClick={() => setContactModalOpen(true)}
              className="px-9 py-4 rounded-full bg-[#0052FF] hover:bg-[#0043D6] text-white text-sm font-semibold inline-flex items-center gap-2 shadow-pb-glow transition-all"
            >
              <span>Start a Project</span>
              <ArrowRight className="w-4 h-4" />
            </button>
