...
const capabilities = [
  { title: "iOS App Development", desc: "Native iPhone and iPad applications built for the Apple ecosystem with full App Store deployment." },
  { title: "Android App Development", desc: "Native Android applications for phones and tablets published to the Google Play Store." },
  { title: "Cross-Platform Apps", desc: "React Native applications that run on both iOS and Android from a single codebase." },
  { title: "Enterprise Mobile Tools", desc: "Internal mobile tools for field teams, operations staff and enterprise workflows." },
  { title: "Client-Facing Mobile Apps", desc: "Customer-facing applications for booking, ordering, support and self-service." },
  { title: "App Modernization", desc: "Rebuild or upgrade existing mobile apps to current platform standards and design patterns." },
];
      ...
      <main className="flex-grow">
        <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <nav className="flex items-center gap-2 text-xs font-mono text-slate-400 mb-12" aria-label="Breadcrumb">
              ...
              <span className="text-[#0052FF]">App Development</span>
            </nav>
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} className="max-w-3xl space-y-6">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#0052FF]/10 border border-[#0052FF]/20 text-[11px] font-mono font-bold text-[#0052FF] tracking-widest uppercase">
                <Smartphone className="w-3.5 h-3.5" /><span>App Development</span>
              </div>
              <h1 className="font-display font-bold text-hero-title text-slate-900 tracking-tight leading-tight">
                Mobile Applications{" "}<span className="text-gradient-blue">Built to Production Standard.</span>
              </h1>
              <p className="text-base sm:text-lg text-slate-600 leading-relaxed font-normal">
                Native and cross-platform mobile applications for iOS and Android — enterprise-grade quality, not prototype complexity. Built for real users and real business operations.
              </p>
              <div className="space-y-3">
                {["iOS and Android native or cross-platform development", "App Store and Google Play deployment handled end-to-end", "Enterprise security, authentication and access control", "Ongoing maintenance and platform updates"].map((item) => (
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                ...
                <Link href="/custom-software-development" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-white border border-slate-200 text-slate-700 hover:border-[#0052FF] hover:text-[#0052FF] text-sm font-medium transition-all">
                  <span>Custom Software</span><ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </motion.div>
          </div>
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white border-y border-slate-200">
          <div className="max-w-7xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="mb-12">
              <span className="text-[11px] font-mono font-bold tracking-widest text-[#0052FF] uppercase block mb-3">APP CAPABILITIES</span>
              <h2 className="font-display font-bold text-3xl sm:text-4xl text-slate-900 tracking-tight">Mobile Development Services.</h2>
            </motion.div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {capabilities.map((cap, idx) => (
                <motion.div key={cap.title} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-15px" }} transition={{ duration: 0.6, delay: idx * 0.07 }} className="p-7 rounded-3xl bg-[#FAFAFC] border border-slate-200 hover:border-[#0052FF]/30 hover:shadow-pb-card hover:shadow-[#0052FF]/5 hover:-translate-y-1 transition-all duration-300 ease-out space-y-3">
                  <div className="w-9 h-9 rounded-xl bg-[#0052FF]/10 text-[#0052FF] flex items-center justify-center"><Smartphone className="w-4 h-4" /></div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#050917] text-white">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <h2 className="font-display font-bold text-3xl sm:text-5xl text-white tracking-tight">Ready to Build Your App?</h2>
            <p className="text-slate-400 text-base max-w-xl mx-auto">Share your app concept and requirements with our team.</p>
