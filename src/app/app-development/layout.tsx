...
export const metadata: Metadata = {
  ...
  openGraph: { title: "App Development | Project Buddy", description: "Native iOS, Android and cross-platform mobile app development. Enterprise-grade quality.", url: "https://projectbuddy.co.in/app-development", siteName: "Project Buddy", type: "website", images: [{ url: "/logo.jpg", alt: "Project Buddy" }] },
