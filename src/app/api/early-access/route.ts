  ...
  try {
    ...
    if (!apiKey) {
      return NextResponse.json(
        { error: "Early access registration is temporarily unavailable. Please email info@projectbuddy.co.in directly." },
        { status: 503 }
      );
    }
    const emailFrom =
      ...
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; color: #0F172A; max-width: 600px; margin: 0 auto; border: 1px solid #E2E8F0; border-radius: 16px; overflow: hidden; background-color: #FFFFFF;">
        ...
        <div style="padding: 28px;">
          ...
          <p style="font-size: 14px; color: #475569;">
            If you have any questions in the meantime, reach us at <a href="mailto:info@projectbuddy.co.in" style="color: #0052FF;">info@projectbuddy.co.in</a>.
          </p>
          <br/>
