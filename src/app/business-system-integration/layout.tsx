...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Business System Integration | Project Buddy", description: "Connect your systems, eliminate silos, build a unified operational environment.", url: "https://projectbuddy.co.in/business-system-integration", siteName: "Project Buddy", type: "website", images: [{ url: "/logo.jpg", alt: "Project Buddy" }] },
