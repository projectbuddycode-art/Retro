...
export const metadata: Metadata = {
  ...
  openGraph: { title: "AI Automation Services | Project Buddy", description: "Practical AI and workflow automation for real business operations. Custom LLM integration, document AI and intelligent automation.", url: "https://projectbuddy.co.in/ai-automation", siteName: "Project Buddy", type: "website", images: [{ url: "/logo.jpg", alt: "Project Buddy" }] },
